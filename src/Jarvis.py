...
from Face_recognition_system.face_recognition_system import verify
from Face_recognition_system.signin import login
...
while True:
    if app.ChatBot.isUserInput():
        print("userinput-----------")
        #take input from GUI
        input_text = app.ChatBot.popUserInput()
        print("got user input:", input_text)

        try:
            #Handle sys.exit()
            print("calling function with", input_text)
            respond(input_text)
        except SystemExit:
